        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-md-12">
            <div class="mb-5 text-center">
              <h1 class="text-white font-weight-bold">Le moyen le plus simple d'obtenir le travail de vos rêves</h1>
        ...
        <div class="row align-items-center">
          <div class="col-12 text-center mt-4 mb-5">
            <div class="row justify-content-center">
              <div class="col-md-7">
                <h2 class="section-title mb-2">Entreprises que nous avons aidées</h2>
        ...
        <div class="owl-carousel single-carousel">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;"Pour toute personne cherchant à évoluer dans sa carrière à l'international, ce site est incontournable. Les offres sont variées et couvrent de nombreux secteurs d'activité. Bravo pour ce travail !"&rdquo;</p>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-6 align-self-center text-center text-lg-left">
                <blockquote>
                  <p>&ldquo;J'ai trouvé ce site très facile à utiliser. La navigation est intuitive et les informations sur les emplois sont très détaillées. De plus, la possibilité de rechercher des emplois dans différents pays est un grand avantage.&rdquo;</p>
