<?php 
  ...
  define("APPURL", "http://localhost/Pigier-ci");

?>
<!doctype html>
<html lang="en">
  <head>
    <title>Pigier-CI &mdash; Website by Henoire</title>
    <meta charset="utf-8">
    ...
    <header class="site-navbar mt-3">
      <div class="container-fluid">
        <div class="row align-items-center">
          <div  class="site-logo col-6"><a href="<?php echo APPURL; ?>"><img src="images/logo-pg.png" alt="pigier-logo" style="width: 20%; heigth:20%" class="pigier"></a></div>
<!--<img src="images/logo-pg.png" alt="pigier">-->
